...
class hr_holidays(osv.osv):
    ...
    def create(self, cr, uid, values, context=None):
        ...
        if values.get('state') and values['state'] not in ['draft', 'confirm', 'cancel'] and not self.pool['res.users']:
    ...
    def write(self, cr, uid, ids, vals, context=None):
        ...
        if vals.get('state') and vals['state'] not in ['draft', 'confirm', 'cancel'] and not self.pool['res.users']:
