...
class project_work(osv.osv):
    ...
    def _create_analytic_entries(self, cr, uid, vals, context):
        ...
        if acc_id:
            ...
            res = timesheet_obj.on_change_account_id(cr, uid, False, acc_id,categ_id)
            if res.get('value'):
            ...
            data = { 'project_category_id': categ_id }
            timesheet_obj.write(cr, uid, [timeline_id], data, context=context)
