...
#                 'user': lambda self, cr, uid, ctx:uid,
    ...
    def submit(self, cr, uid, ids, context=None):
        ...
        'body_html': change.name + ' ' + 'MRF request Intiated. Please take necessary action.<br/><br/><br/>Kindly do not reply.<br/>---This is auto generated email---<br/>Regards:<br/>ERP HR Team<br/>IDS Infotech LTD.<br/>Url:'+url,
    ...
    def validate(self, cr, uid, ids, context=None):
        ...
        values = {
        'subject': 'MRF Request' + ' ' + change.name,
        'body_html': 'Your MRF request is approved.Please take further necessary action.<br/><br/><br/>Kindly do not reply.<br/>---This is auto generated email---<br/>Regards:<br/>ERP HR Team<br/>IDS Infotech LTD.<br/>Url:'+url,
        'email_to': change.requested_employee_id.work_email,
        'email_cc': change.requested_employee_id.division.hr_email,
        'email_from': 'info.openerp@idsil.com',
          }
        #---------------------------------------------------------------
        mail_obj = self.pool.get('mail.mail') 
    ...
    def approve(self, cr, uid, ids, context=None):
        ...
        values = {
        'subject': 'MRF Request' + ' ' + change.name,
        'body_html': 'Your MRF request is Closed.<br/><br/><br/>Kindly do not reply.<br/>---This is auto generated email---<br/>Regards:<br/>ERP HR Team<br/>IDS Infotech LTD.<br/>Url:'+url,
        'email_to': change.requested_employee_id.parent_id.work_email,
    ...
    def refuse(self, cr, uid, ids, context=None):
        ...
        values = {
        'subject': 'MRF Request' + ' ' + change.name,
        'body_html': 'Your MRF request is refused . Please Contact to your HR department.<br/><br/><br/>Kindly do not reply.<br/>---This is auto generated email---<br/>Regards:<br/>ERP HR Team<br/>IDS Infotech LTD.<br/>Url:'+url,
        'email_to':  change.requested_employee_id.work_email,
        'email_from': 'info.openerp@idsil.com',
          }
        #---------------------------------------------------------------
